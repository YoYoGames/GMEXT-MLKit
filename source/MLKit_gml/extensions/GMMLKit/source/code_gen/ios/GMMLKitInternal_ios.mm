...
@interface GMMLKitInternal ()
{
    gm::runtime::DispatchQueue __dispatch_queue;
    id<GMMLKitInterface> __impl;
}@end


@implementation GMMLKitInternal
...
+ (void)load
{
    ...
    Class base = [GMMLKitInternal class];
...
- (instancetype)init
{
    ...
    if (self)
    {
        __impl = (id<GMMLKitInterface>)self;
    }
    return self;
}
- (double)__EXT_NATIVE__mlkit_translation_create:(char*)source arg1:(char*)target
{
    double __result = [__impl mlkit_translation_create:source target:target];
...
- (double)__EXT_NATIVE__mlkit_translation_model_is_available:(char*)__arg_buffer arg1:(double)__arg_buffer_length
{
    ...
    [__impl mlkit_translation_model_is_available:translator callback:callback];
...
- (double)__EXT_NATIVE__mlkit_translation_translate:(char*)__arg_buffer arg1:(double)__arg_buffer_length
{
    ...
    [__impl mlkit_translation_translate:translator text:text callback:callback];
...
{
    [__impl mlkit_translation_close:translator];
...
- (double)__EXT_NATIVE__mlkit_translation_get_downloaded_list:(char*)__arg_buffer arg1:(double)__arg_buffer_length
{
    ...
    [__impl mlkit_translation_get_downloaded_list:callback];
...
- (double)__EXT_NATIVE__mlkit_translation_model_delete:(char*)__arg_buffer arg1:(double)__arg_buffer_length
{
    ...
    [__impl mlkit_translation_model_delete:language callback:callback];
...
- (double)__EXT_NATIVE__mlkit_translation_model_download:(char*)__arg_buffer arg1:(double)__arg_buffer_length
{
    ...
    [__impl mlkit_translation_model_download:language callback:callback];
