...
void Init_GMMLKitLanguageIdentification()
{
    ...
    libHandle = ExtUtils_GetLibraryHandle("GMMLKitLanguageIdentification.ext");
    if (libHandle)
    {
...
void Startup_GMMLKitLanguageIdentification()
{
...
void Shutdown_GMMLKitLanguageIdentification()
{
    if (!isInitialized) return;
