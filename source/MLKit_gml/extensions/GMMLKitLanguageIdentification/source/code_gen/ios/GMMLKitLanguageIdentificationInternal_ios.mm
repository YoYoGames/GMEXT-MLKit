...
#import "GMMLKitLanguageIdentificationInternal_ios.h"
...
@interface GMMLKitLanguageIdentificationInternal ()
{
    gm::runtime::DispatchQueue __dispatch_queue;
    id<GMMLKitLanguageIdentificationInterface> __impl;
}@end


@implementation GMMLKitLanguageIdentificationInternal
...
+ (void)load
{
    ...
    Class base = [GMMLKitLanguageIdentificationInternal class];
...
- (instancetype)init
{
    ...
    if (self)
    {
        __impl = (id<GMMLKitLanguageIdentificationInterface>)self;
    }
    return self;
}
- (double)__EXT_NATIVE__mlkit_language_identification_identify:(char*)__arg_buffer arg1:(double)__arg_buffer_length
{
    ...
    [__impl mlkit_language_identification_identify:text callback:callback];
